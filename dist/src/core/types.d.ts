...
export declare type DirStructureAuto = 'auto' | 'file' | 'dir';
export declare type DirStructure = 'file' | 'dir';
...
export declare type RewriteKeySource = 'source' | 'reference' | 'write';
export declare type KeyStyle = 'auto' | 'nested' | 'flat';
...
export declare enum TargetPickingStrategy {
    None = "none",
    MostSimilar = "most-similar",
    FilePrevious = "file-previous",
    GlobalPrevious = "global-previous"
}
export declare type DetectionSource = 'html-attribute' | 'html-inline' | 'js-string' | 'js-template' | 'jsx-text';
